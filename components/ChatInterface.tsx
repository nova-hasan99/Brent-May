          ...
          {!isInitialized ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-8 max-w-lg mx-auto leading-relaxed">
                ...
                100% accurate. All intellectual property belongs to Brent May.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto mb-8">
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Broker leading Bayside, showcasing Huatulco’s sustainable, low-density, sunny, affordable oceanfront market to investors globally.
                  </p>
                </div>
                ...
                <div className="text-center p-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Get specific video guidance from Brent's content library
                  </p>
                </div>
              </div>
            </div>
